...
module.exports = (app) => {
    ...
    app.post('/users/password/forget', PASSWORD_FORGET_POST_API);
    app.post('/users/password/reset', PASSWORD_RESET_POST_API);
    app.post('/users/password/change', AuthenticateMiddleware, PASSWORD_CHANGE_POST_API);
